...
const HeroBanner = () => {
    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 p-10 my-10'>
            <div className='flex flex-col justify-center items-center md:items-start ml-10 md:ml-20 my-10 md:my-2'>
            ...
            <div className='flex justify-center'>
                <div className={`bg-orange-400 h-[70vh] w-80 rounded-md transition-all duration-500 ease-in-out absolute ${hoverHeroImage && 'translate-x-6 -translate-y-3'}`}></div>
                <img className={`block h-[70vh] w-80 z-10 translate-x-3 -translate-y-3 transition-translate duration-500 ease-in-out ${hoverHeroImage && 'translate-x-0 translate-y-0'}`} src={HeroPicture} alt="HeroImg" 
